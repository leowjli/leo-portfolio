    ...
    return (
      <article>
        ...
        <div className="product-display">
          ...
          <button className="hifi-btn"><Link to="https://www.figma.com/proto/zg6wKWPnHLk2YBRpXpeGfU/Slang-Use-Mobile-App?page-id=50%3A1188&type=design&node-id=50-12162&viewport=-154%2C499%2C0.13&t=m1aUDZGR4qzgzPWa-1&scaling=min-zoom&starting-point-node-id=50%3A12154&mode=design" target="_blank">View Prototype</Link></button>
        </div>
      </article>
    );
  }