      ...
      <article>
        ...
        <section className="sketches">
          ...
          <div className="sketches-img">
            <img src="/img/slangsphere/SS sketches.png" alt="brainstorm sketches for problem" />
            <img src="/img/slangsphere/SS sketches 2.png" alt="brainstorm sketches for problem part 2" />
          </div>
        </section>
        <section className="prototype">
          ...
          <img src="/img/slangsphere/SS lo-fi.png" alt="low fidelity prototype for splangsphere" />
        </section>
        ...
        <div className="ss-design">
          ...
          <h1>A streak + achievement-based way to learn about the slang we use.</h1>
        </div>
        <div className="product-display">
          <h2 style={{color: "#e7f5fa"}}>Introducing</h2>
          <h1>SlangSphere</h1>
          <img src="/img/slangsphere/SlangSphere Thumbnail.png" alt="SlangSphere Project Thumbnail"/>
          <img src="/img/slangsphere/SS Final Designs.png" alt="SlangSphere final design features"/>
